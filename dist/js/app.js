...
$(document).ready(function () {
  ...
  $('.request-success__toggle').on('click', function (e) {
    e.preventDefault();
    $('.request-success__popup').addClass('active');
  });
  $('.request-error__toggle').on('click', function (e) {
    e.preventDefault();
    $('.request-error__popup').addClass('active');
  });
  $(document).mouseup(function (e) {
    if ($('.request__popup').hasClass('active') && ($('.request__popup').is(e.target) && $('.request__popup').has(e.target).length === 0 || $('.request__popup .form__close').is(e.target) || $('.request__popup .form__close').has(e.target).length != 0)) {
      $('.request__popup').removeClass('active');
    }
    if ($('.request-success__popup').hasClass('active') && ($('.request-success__popup').is(e.target) && $('.request-success__popup').has(e.target).length === 0 || $('.request-success__popup .form__close').is(e.target) || $('.request-success__popup .form__close').has(e.target).length != 0)) {
      $('.request-success__popup').removeClass('active');
    }
    if ($('.request-error__popup').hasClass('active') && ($('.request-error__popup').is(e.target) && $('.request-error__popup').has(e.target).length === 0 || $('.request-error__popup .form__close').is(e.target) || $('.request-error__popup .form__close').has(e.target).length != 0)) {
  ...
  (0,autosize__WEBPACK_IMPORTED_MODULE_2__["default"])($('textarea'));
});
